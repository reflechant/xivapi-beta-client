...
class SearchResult:
    ...
    Attributes:
        score (float): Relevance score for this entry.

            These values only loosely represent the relevance of an entry to the search query. No guarantee is given that
            the discrete values, nor resulting sort order, will remain stable.
        sheet (str): Excel sheet this result was found in.
